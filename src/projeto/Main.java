   ...
   private static void menuReservasMateriais() {
       ...
       while (!voltar) {
           ...
           switch (opcao_menu_reserva_material) {
               case 1:
                   cadastro.reservarMaterial(); // Chame o método de reserva de material
                   limparConsole();
                   break;
               case 2:
                   cadastro.listarReservasMateriais(); // Corrigido para listar reservas de materiais
                   break;
               case 3:
                   voltar = true;
                   break;
   ...
   private static void menuReservasAmbientes() {
       ...
       while (!voltar) {
           ...
           switch (opcao_menu_reserva_ambiente) {
               case 1:
                   cadastro.reservarAmbiente(); // Chame o método de reserva de ambiente
                   limparConsole();
                   break;
               case 2:
                   cadastro.listarReservasAmbientes(); // Corrigido para listar reservas de ambientes
                   break;
               case 3:
                   voltar = true;
                   break;
